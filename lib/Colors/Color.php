...
class Color
{
    ...
    protected $styles = array(
        ...
        'darkgray'        => "\033[90m%s\033[0m",
        'lightred'        => "\033[91m%s\033[0m",
        'lightgreen'      => "\033[92m%s\033[0m",
        'lightyellow'     => "\033[93m%s\033[0m",
        'lightblue'       => "\033[94m%s\033[0m",
        'lightmagenta'    => "\033[95m%s\033[0m",
        'lightcyan'       => "\033[96m%s\033[0m",
        ...
        'bg_darkgray'     => "\033[100m%s\033[0m",
        'bg_lightred'     => "\033[101m%s\033[0m",
        'bg_lightgreen'   => "\033[102m%s\033[0m",
        'bg_lightyellow'  => "\033[103m%s\033[0m",
        'bg_lightblue'    => "\033[104m%s\033[0m",
        'bg_lightmagenta' => "\033[105m%s\033[0m",
        'bg_lightcyan'    => "\033[106m%s\033[0m",
        'bg_brightwhite'  => "\033[107m%s\033[0m"
    );
